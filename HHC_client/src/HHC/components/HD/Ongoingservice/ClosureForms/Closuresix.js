...
const Closuresix = ({ formNo, evePlanID, profSD, profST, profED, profET, sessions, onClose }) => {
            ...
            <Box sx={{ flexGrow: 1, bgcolor: "#ffffff" }}>
                ...
                <Grid item xs={12} container spacing={1} sx={{ mt: 2 }}>
                    <Grid item xs={12} sm={12} md={12} lg={12}>
                        <TextField id="standard-basic" required label="Remark" variant="outlined" multiline
