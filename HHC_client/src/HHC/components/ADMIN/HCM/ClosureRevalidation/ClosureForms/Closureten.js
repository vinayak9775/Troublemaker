...
const Closureten = ({
  ...
  const [strengthExer, setStrengthExer] = useState(null);
  console.log(strengthExer, "strengthExer");
// >>>>>>> Stashed changes

  const [stretchExer, setStretchExer] = useState(null);
  const [walkIndep, setWalkIndep] = useState(null);
  const [walkerStick, setWalkerStick] = useState(null);
  ...
  const handleEmptyField = () => {
    ...
    if (!closureRevalidateRemark) {
      newErrors.closure_revalidate_remark = "Required";
    }
    setErrors(newErrors);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log(sessionDetails[0]?.Strength_exer, "gggg");
        ...
        setStrengthExer(sessionDetails[0]?.Strength_exer || "");
        setStretchExer(sessionDetails[0]?.Stretch_exer || "");
        setWalkIndep(sessionDetails[0]?.Walk_indep || "");
        setWalkerStick(sessionDetails[0]?.Walker_stick || "");
    ...
    <>
      ...
      >
        <div style={{ display: "flex" }}>
          ...
          <Button
            onClick={onClose}
            sx={{ marginLeft: "160px", marginTop: "2px", color: "gray" }}
          >
            <CloseIcon />
          </Button>
        </div>
        ...
        <Grid item xs={12} container spacing={1} sx={{ mt: 1 }}>
            ...
            >
              <FormControl>
                <FormLabel id="demo-row-radio-buttons-group-label">
                  Strengthening exercises were done
                </FormLabel>
                <RadioGroup
                  row
          ...
          <Grid item xs={12} sm={12} md={12} lg={12}>
            ...
            >
              <FormControl>
                <FormLabel id="demo-row-radio-buttons-group-label">
                  Stretching exercises were done
                </FormLabel>
                <RadioGroup
                  row
                  aria-labelledby="demo-row-radio-buttons-group-label"
          ...
          <Grid item xs={12} sm={12} md={12} lg={12}>
            ...
            >
              <FormControl>
                <FormLabel id="demo-row-radio-buttons-group-label">
                  Patient is walking independently
                </FormLabel>
                <RadioGroup
                  row
                  aria-labelledby="demo-row-radio-buttons-group-label"
