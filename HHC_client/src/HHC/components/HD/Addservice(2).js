...
const Addservice = () => {
    ...
    //Calculate time
    const [srvHrs, setSrvHrs] = useState(enqToServiceSrv.sub_srv_id ? enqToServiceSrv.sub_srv_id.Service_Time : null);
    ...
    const handleFieldChange = (field, value) => {
        ...
        //     setEnqToServicePtn({});
        // }
        // setEnqToServicePtn((prevData) => ({ ...prevData, [field]: value }));
    ...
    useEffect(() => {
        const calculateTotalAmount = async () => {
            if (getCost && startDate && endDate) {
                ...
                console.log("Cost, Dates.....", getCost, startDate, endDate);
                try {
    ...
    }, [getCost, startDate, endDate, calculatedAmount]);
                                            ...
                                            >
                                                <Box
                                                    ...
                                                    <div>
                                                        ...
                                                        <Button variant="contained" sx={{ textTransform: "capitalize", ml: 15, width: "20ch", mt: 2 }} onClick={handleCloseQuestions}>Save</Button>
                                                    </div>
                                            ...
                                            >
                                                <Box sx={{
                                                    ...
                                                    <div>
                                                        ...
                                                        <Button variant="contained" sx={{ textTransform: "capitalize", ml: 18, width: "20ch", mt: 2 }} onClick={handleCloseQuestions}>Save</Button>
                                                    </div>
