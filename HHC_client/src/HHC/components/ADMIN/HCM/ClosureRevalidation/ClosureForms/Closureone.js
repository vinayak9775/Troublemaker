...
const Closureone = ({ getSessionDetils,formNo, evePlanID, profSD, profST, profED, profET, sessions, onClose,eveID }) => {

    const port = process.env.REACT_APP_API_KEY;
    const accessToken = localStorage.getItem('token');

    const [baseline, setBaseline] = useState(null);
    const [airway, setAirway] = useState(null);
      ...
      useEffect(() => {
        const fetchData = async () => {
          try {
            ...
            setBaseline(sessionDetails[0]?.Baseline || "");
            setAirway(sessionDetails[0]?.Airway || "");
            setBreathing(sessionDetails[0]?.Breathing || "");
            setCirc(sessionDetails[0]?.Circulation || "");
            setSkin(sessionDetails[0]?.Skin_Perfusion || "");
    ...
    return (
        <>
            <Box sx={{ flexGrow: 1, ml: 1, mr: 1, mt: 1, bgcolor: "#ffffff",  overflow: "auto",
          maxHeight: "500px",
          Width: "100%",p:2, }}>
                        ...
                        <Box sx={{ border: '1px solid #B2B3AE', borderRadius: "4px", padding: '10px' }}>
                            <FormControl>
                                ...
                                <RadioGroup
                                    ...
                                    name="Airway"
                                    value={airway}
                                    onChange={(e) => setAirway(parseInt(e.target.value, 10))}
                                >
                        ...
                        <Box sx={{ border: '1px solid #B2B3AE', borderRadius: "4px", padding: '10px' }}>
                            <FormControl>
                                ...
                                <RadioGroup
                                    ...
                                    name="Breathing"
                                    value={breathing}
                                    onChange={(e) => setBreathing(parseInt(e.target.value, 10))}
                        ...
                        <Box sx={{ border: '1px solid #B2B3AE', borderRadius: "4px", padding: '10px' }}>
                            <FormControl>
                                ...
                                <RadioGroup
                                    ...
                                    name="Circulation"
                                    value={circ}
                                    onChange={(e) => setCirc(parseInt(e.target.value, 10))}
                                // error={!!errors.circ}
          ...
          <Grid item xs={12}>
             <TextField
                          ...
                          placeholder="Closure Revalidate Remark"
                          variant="outlined"
                          multiline
                          RowsMax={4}
                          required
