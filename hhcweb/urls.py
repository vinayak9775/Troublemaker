...
urlpatterns = [
    ...
    path('agg_hhc_prof_loc_aval_dtl/',views.agg_hhc_service_professional_loc_dtl.as_view()), # Display list of prof location with lat longs and availability
    ...
    path('TotalServicesOngoingPendingCompleted/', views.TotalServicesOngoingPendingCompleted.as_view(), name='total_amount_received'),
    ...
    path('send-message/', views.SendMessageView2.as_view(), name='send-message'),
    # path('check-status/<str:message_id>/', views.CheckMessageStatusView.as_view(), name='check-status'),
    ...
    path('feedback_questions_app/', views.FeedbackQuestionsAPIView_for_app.as_view(), name='feedback-questions'),
    path('send_whatsapp_sms_allocation/', views.SendMessageView_for_allocation.as_view(), name='send-message'),
    path('send_message_testing/', views.SendMessageView.as_view(), name='send-message'),
    ...
    path('Calculate_pending1_enquiry/', views.pending1_Total_enquiry.as_view(), name='total_amount_received'),
    
    path('send_cashfree_link/', views.create_payment_url_whatsapp, name='send-message'),
    ...
    path('update_transaction_status_for_app/', views.update_transaction_status_for_community_app, name='update_transaction_'),



# prof avai
    # path('total_prof_count',views.agg_hhc_total_prof.as_view()),
   # Chatbot Prajakta
    path('chatbot/conversations/', views.ChatbotConversationView.as_view(), name='chatbot-conversations'),
    

    path('generate_invoice_pdf/<int:eve_id>', views.generate_invoice_pdf, name='generate_invoice_pdf'),
    path('generate_invoice_pdf_view/<int:eve_id>', views.generate_invoice_pdf_view, name='generate_invoice_pdf'),
    
    path('prof_H_zone_loc', views.get_active_professionals, name='ZONE_LOCATION'),
    ...
    # path('professional_reuest_approval/<int:res_can>/<int:srv_sess>/', views.request_approvals.as_view()),
    ...
    path('Group_N/', views.group_and_type_Views.as_view()),                                         # For HR Module - System User - Get Group Name - Amit
    ...
    path('11add_Group_module/', views.create_group_module_Views.as_view()),
...
# ------------------------------------------Sandip-------------------------------------------------
    ...
    path('update_invoice_id/', views.update_invoice_id.as_view()), 
    # path('demoview/<int:pk>/', views.demoview.as_view()),
    ...
    path('hospital_dashboard_srv_count/<str:hosp_id>/<int:id>/',views.hospital_dashboard_srv_count.as_view()),
    path('hospital_dashboard_enquiry_follow_up_count/<str:hosp_id>/<int:id>/',views.hospital_dashboard_enquiry_follow_up_count.as_view()),
    path('hospital_dashboard_service_details/<str:hosp_id>/<int:id>/',views.hospital_dashboard_service_details.as_view()),
    path('hospital_dashboard_enquiry_count/<str:hosp_id>/<int:id>/',views.hospital_dashboard_enquiry_count.as_view()),
    ...
    path('Ambulances/<int:prof_id>/', views.Ambulances.as_view()),
