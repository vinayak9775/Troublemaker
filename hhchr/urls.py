...
#---------------------------------SANDIP working on this api vishal working  on excel ---------------------------------------------
    ...
    path('edit_register_professional/<int:srv_prof_id>/',edit_register_professional_from_hr.as_view()),      
...
# ------------------------------------------------------------------- Amit -------------------------------------------------------------
    path('Our_Employees_List/', Our_EMPLOYEE_List_VIew.as_view()),                      # Our Employees    13-08-2024                       Amit
    ...
    path('check_file_API_VIew/<int:srv_prof_id>/', check_file_API_VIew.as_view()),                       # Post File API Employees    13-08-2024             Amit
...
# Closure Revalidate Amit
    path('Ongoing_Event_Closure_Revalidate/', Closure_Revalidate_Ongoing_Eve.as_view()), 
    path('ServiceCancellationView_Closure_Revalidate/<int:eve_id>/', Closure_Revalidate_ServiceCancellationView.as_view()),     # GET POST API
    ...
    path('datewise_job_closure_Revalidate/',datewise_job_closure_Revalidate_dtls.as_view()),    # GET API
    path('datewise_job_closure_Revalidate/<str:from_date>/<str:to_date>/',datewise_job_closure_Revalidate_dtls.as_view()),      # GET API
    path('update_job_closure_form_api/<str:jc_id>/',update_job_closure.as_view()),              # PUT API 
    path('event_wise_job_clouser_dtls/<int:eve_id>/',event_wise_job_clouser_dtls.as_view()),    # Get API

    path('all_dtl_evnts_closure_Revalidate/',all_dtl_evnts_closure_Revalidate.as_view()), # Display All Detailed Events against particular Event 
    path('get_selected_job_Closure_Revalidate_question/<int:eve_id>/', get_selected_job_Closure_Revalidate_question.as_view()), 
    path('get_selected_job_Closure_Revalidate_question/<int:eve_id>/<int:lang_id>', get_selected_job_Closure_Revalidate_question.as_view()), 
    ...
    path('job_closure_srv_sess_wise_Closure_Revalidate/<int:srv_prof_id>/<int:dtl_eve_id>/', job_closure_srv_sess_wise_Closure_Revalidate.as_view()),     # GET POST API

    path('agg_hhc_session_job_closure/',agg_hhc_session_job_closure.as_view()),# Post API to submit job closure as per session  changed                 Create get API 
...
#-----------------------------Mohin--------------------------------------------
    ...
    path('cv_post_api/', CvCreateView.as_view(), name='cv_post_api'),
