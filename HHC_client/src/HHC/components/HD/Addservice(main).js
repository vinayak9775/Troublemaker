...
const Addservice = () => {
    ...
    useEffect(() => {
        const calculateTotalAmount = async () => {
            ...
            if (getCost && startDate && endDate && lat && long) {
                // if (selectedSubService && startDate && endDate && lat && long) {
                console.log("Cost, Dates lat long.....", getCost, startDate, endDate, lat, long);
                try {
                    ...
                    // console.log("Calculated Service Cost datewise with Convenience .....", total);
    ...
    }, [getCost, startDate, endDate, lat, long]);
                                    ...
                                    <Grid item lg={12} sm={12} xs={12}>
                                        <Box component="form" sx={{ p: "2px 4px", display: 'flex', alignItems: 'center', height: '2.4rem', backgroundColor: "#CBE3FF", boxShadow: "4px 4px 10px 7px rgba(135, 135, 135, 0.05)", borderRadius: "10px", }}>
                                            ...
                                            <InputBase
                                                ...
                                                // value={enqToServicePay ? enqToServicePay.final_amount : `₹${(selectedDiscountId === 4 ? parseFloat(totalAmount).toFixed(2) : (discountValue === '' || discountValue === null) ? totalAmount : totalDiscount !== null && totalDiscount !== undefined ? totalDiscount : calculatedAmount)}`}
