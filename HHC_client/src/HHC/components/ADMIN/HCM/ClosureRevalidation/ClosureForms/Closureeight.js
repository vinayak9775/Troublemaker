...
const Closureeight = ({ getSessionDetils, formNo, evePlanID, profSD, profST, profED, profET, sessions, onClose, eveID }) => {
    ...
    const [sutures, setSutures] = useState(null);
    const [staples, setStaples] = useState();
    const [dehiWound, setDehiWound] = useState(null);
    ...
    console.log("Closure Form 8 dates times", startDate, startTime, endDate, endTime)
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setSutures(sessionDetails[0]?.Sutures_type || "");
                setStaples(sessionDetails[0]?.Num_Sutures_staples || "");
                setDehiWound(sessionDetails[0]?.Wound_dehiscence || "");
    ...
    async function handleClosureEightSubmit(event) {
        ...
        try {
            ...
            // Use a timeout to ensure the UI updates
        ...
        <>
            <Box sx={{ flexGrow: 1, bgcolor: "#ffffff" }}>
                <div style={{ display: "flex", }}>
                    <Typography align="center" style={{ fontSize: "16px", fontWeight: 600, marginTop: "10px", }}>CLOSURE Vali FORM</Typography>
