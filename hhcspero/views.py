...
class SendSMSView(APIView):
    ...
    def post(self, request):
        ...
        message = f"Thank you for enquiring at SPERO Healthcare For Home Healthcare Services. Please use https://hhc.hospitalguru.in/{fronturl}/{userpage} for availing our services or call help line no {helpline_number}"
