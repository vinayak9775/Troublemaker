...
const DayPrintBHV = () => {
  ...
  console.log(hospitalType, "lllll");
      ...
      <Box sx={{ flexGrow: 1, ml: 1, mr: 1, mt: 1 }}>
        <Box sx={{ display: "flex", justifyContent: "left" }}>
          ...
          >
            ...
            <Box sx={{ mb: 1, width: 200, marginLeft: "1rem" }}>
              <TextField
                select
                ...
                sx={{
                  ...
                  boxShadow: "4px 4px 10px 7px rgba(135, 135, 135, 0.05)",
                  borderRadius: "7px",
                  '& .MuiMenu-paper': { maxHeight: '200px', overflowY: 'auto' }
                  

                }}
                InputProps={{ style: { border: "none" } }}
                inputProps={{ "aria-label": "Select Payment Method" }}
                value={paymentMethod}
              ...
              >
                ...
                <MenuItem value={5}>QR Code</MenuItem>
                <MenuItem value={6}>NEFT</MenuItem>
          ...
          >
            <thead>
              <tr style={{ textAlign: "right" }}>
                ...
                >
                  Print on: <span id="printTime"></span>
                </th>
              </tr>
              ...
              <tr style={{ textAlign: "center" }}>
                ...
                >
                  Cash - Service{" "}
                  {paymentPatient.length > 0 ? paymentPatient[0].hhcid : ""}
                </th>
              </tr>
              <tr style={{ textAlign: "center" }}>
                <th colSpan="6" style={{ whiteSpace: "pre-wrap" }}>
                  Cash - In - hand
                </th>
              </tr>
              <tr>
