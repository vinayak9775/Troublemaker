...
# prof avai
   ...
   # Chatbot Prajakta
    ...
    path('Get_User/', views.Create_Get_User_Views.as_view()),
    path('Group_N/', views.group_and_type_Views.as_view()),      
    path('Post_User/', views.Create_Post_User_Views.as_view()),
    path('Edit_User/<int:clg_id>/', views.Edit_User_Views.as_view()),   
    path('active_inActive_User/<int:clg_id>/', views.active_inActive_User_Views.as_view()),      

    
    path('add_Group_module/', views.create_group_module_Views.as_view()),
