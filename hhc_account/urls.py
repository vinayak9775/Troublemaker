...
# --------------------------------- Vinayak ------------------------------------------
    ...
    # path('View_professional_unit_report/<int:srv_prof_id>/',views.View_professional_unit_report.as_view()),
    ...
    path('View_professional_unit_report22/<int:srv_prof_id>/<str:start_date>/<str:end_date>/',views.View_professional_unit_report22.as_view()),
