...
const ConsultantReport = () => {
    ...
    const handleViewReport = async () => {
        ...
        if (!consultantType && !startDate && !endDate) {
    ...
    return (
        <div style={{ marginBottom: '2em' }}>
                                            ...
                                            <ConsultCard style={{ height: '3rem', background: "white", color: "rgba(0, 0, 0, 0.87)", fontWeight: "100", borderRadius: "8px 10px 8px 8px" }}>
                                                ...
                                                <CardContent style={{ flex: 2, borderRight: "1px solid #FFFFFF" }}>
                                                    <Typography variant='subtitle2'>
                                                        {consultantData.event_plan_of_care[0].start_date ? new Date(consultantData.event_plan_of_care[0].start_date).toLocaleDateString('en-US', {
                                                            year: 'numeric',
                                                            month: 'short',
                                                            day: '2-digit'
                                                        }) : '-'}
            ...
            >
                <Alert onClose={() => setOpenSnackbar(false)} severity="warning" sx={{ width: '100%', marginTop: '50vh' }}>
                    {snackbarMessage}
                </Alert>
            </Snackbar>
        </div>
